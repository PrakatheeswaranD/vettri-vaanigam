...
const DEFAULT_GROWTH_CONFIG = {
  ...
  maxCrossSellItems: 3,
  maxBundleItems: 2,
  dailyDiscountBudgetMinor: 250_000,
  weeklyCampaignBudgetMinor: 1_000_000,
  maxCustomersContactedPerDay: 100,
  maxContactsPerCustomerPerWeek: 2,
  minCampaignMarginBps: 1_500,
  campaignCooldownHours: 168,
  automaticStopLossBps: 2_000,
  defaultShippingCostMinor: 0,
  paymentFeeBps: 200,
  expectedReturnRateBps: 0,
  quietHoursStart: 21,
  quietHoursEnd: 9,
  consentRequired: true,
  outboundChannels: ["BUYER_AGENT"] as Array<"EMAIL" | "WHATSAPP" | "SMS" | "PUSH" | "BUYER_AGENT">,
  categoryDiscountLimits: {} as Record<string, number>,
