        ...
        <CardBody className="space-y-3">
          ...
          <div className="flex flex-col gap-2 border-t border-border pt-3">
            <button
              ...
              className="inline-flex w-full items-center justify-center gap-1.5 rounded-lg bg-brand-600 px-3 py-2 text-xs font-semibold text-white shadow-sm hover:bg-brand-700 transition"
            >
              <ShieldCheck size={14} />
              Propose Agentic Purchase
            </button>
